...
<body >
    ...
    <header>
        <div class="container-fluid position-relative no-side-padding">
            ...
            <a href="#" class="logo"><img src=" {{ asset('assets/fontend/images/logo.png') }} " alt="Logo Image"></a>
 ...
 <div class="col-lg-4 col-md-6">
    ...
    <script src="{{ asset('assets/fontend/js/common-js/jquery-3.1.1.min.js') }} "></script>

    <script src="{{ asset('assets/fontend/js/common-js/tether.min.js') }} "></script>

      <script src="{{ asset('assets/fontend/js/common-js/bootstrap.js') }} "></script>

    <script src="{{ asset('assets/fontend/js/common-js/scripts.js') }} "></script>
