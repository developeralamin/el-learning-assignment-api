...
<div class="row clearfix">
  ...
  {{-- end this section --}}
    ...
    <div class="controls">
   <img id="blah" alt="your image" width="400" height="400" src="{{url('img/course/'.$editData->photo) ?? ''}}" style="width: 300px;height: 300px;border: 1px solid #000000" alt="User Avatar"> 
